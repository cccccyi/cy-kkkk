...
<script setup lang="ts">
    ...
    const blockedSymbols = ['FDRY','42', 'ELIZA','SYRA','REL','MOEW','OBI','JOBS','SERV','BNKR','ZAUTH','GLORIA','OLAS','MAGIC','OPUS','PRXVT','JTVO','AIN','ARBUS','BREW','MRDN','ZARA','SKL','KARUM','KHO','AURA','U402']
