...
<script>
import { fetchTimelineList } from '@/api/crawler'
...
export default {
  ...
  methods: {
    getList() {
      ...
      fetchTimelineList(this.listQuery).then(response => {
    ...
    handleExport() {
      ...
      const url = `https://156.255.105.5:1443/boost_interface/vue-element-admin/page/exportPostInsightsList?${params.join('&')}`
