<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.screen_name" placeholder="账号" clearable class="filter-item" style="width:120px" />&nbsp;
    ...
    >
      ...
      <el-table-column label="背景" width="100px">
        <template slot-scope="{row}">
          <el-aside width="80px" style="background:#fff;padding:0;margin:0;">
              <el-image v-if="row.profile_banner_url" :src="row.profile_banner_url" referrerPolicy="no-referrer"></el-image>
          </el-aside>
        </template>
      </el-table-column>
...
<script>
import { fetchTwAccountList, crawlTaskStatistic } from '@/api/crawler'
