<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.corpus_text_id" placeholder="文" clearable class="filter-item" style="width:60px" />&nbsp;
      <el-input v-model="listQuery.corpus_image_id" placeholder="图" clearable class="filter-item" style="width:60px" />&nbsp;
      <el-input v-model="listQuery.browser_dir" placeholder="号" clearable class="filter-item" style="width:60px" />&nbsp;
    ...
    >
      <el-table-column 
        label="ID" prop="id" sortable="custom" align="center" width="60px" :class-name="getSortClass('id')">
      ...
      <el-table-column label="成员" align="center">
        <template slot-scope="{row}">
          <el-link :href="row.account_url" target="_blank">
            {{ row.user_name }}
            <el-tag size="mini" :type="row.user_type === 'Page' ? 'primary' : 'success'">{{row.user_type}}</el-tag>
          </el-link>
        </template>
      </el-table-column>
      <el-table-column label="帖子" align="center">
        <template slot-scope="{row}">
          <el-link :href="row.post_url" target="_blank" type="primary">{{ row.post_time }}</el-link>
        </template>
      </el-table-column>
      <el-table-column label="评论" class-name="status-col" width="165px">
        <template slot-scope="{row}">
      ...
      <el-table-column label="舆材" align="center">
        <template slot-scope="{row}">
...
<script>
import { fetchMemberList, createKeyword, updateKeyword } from '@/api/group'
