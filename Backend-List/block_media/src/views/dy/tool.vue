<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-edit" @click="handleCreate">转换</el-button>&nbsp;
    </div>
    ...
    >
      ...
      <el-table-column label="配置名" width="">
        <template slot-scope="{row}">
          <span>{{ row.name }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="dialogStatus==='create'?createData():updateData()">导出Excel</el-button>
      </div>
    </el-dialog>
...
<script>
import { fetchConfigList, jsonDataFormat, updateConfig } from '@/api/douyin'
