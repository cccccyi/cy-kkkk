...
const weiboParseProcess = require('./weibo_data_parse')
...
const coinTelegraphProcess = require('./cointelegraph_data_parse')
const binanceProcess = require('./binance_data_parse')
const okxProcess = require('./okx_data_parse')
const coinglassProcess = require('./coinglass')
const coinankProcess = require('./coinank_data_parse')
const okcisProcess = require('./okcis_data_parse')
const websocketProcess = require('./websocket_parse')
...
for (const funName in weiboParseProcess) {
    exports[funName] = weiboParseProcess[funName]
}
...
for(const funName in coinTelegraphProcess){
    exports[funName] = coinTelegraphProcess[funName]
}
...
for(const funName in okxProcess){
    exports[funName] = okxProcess[funName]
}

for(const funName in coinglassProcess){
    exports[funName] = coinglassProcess[funName]
}

for(const funName in coinankProcess){
    exports[funName] = coinankProcess[funName]
}

for(const funName in okcisProcess){
    exports[funName] = okcisProcess[funName]
}

for(const funName in websocketProcess){
    exports[funName] = websocketProcess[funName]
}