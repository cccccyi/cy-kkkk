<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.author" placeholder="作者" clearable class="filter-item" style="width:120px" />&nbsp;
...
<script>
import { fetchBilibiliVideos } from '@/api/material'
...
export default {
  ...
  methods: {
    getList() {
      ...
      fetchBilibiliVideos(this.listQuery).then(response => {
