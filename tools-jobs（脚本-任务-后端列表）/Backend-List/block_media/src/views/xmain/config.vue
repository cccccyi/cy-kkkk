    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="100px" style="width:600px; margin-left:50px;">
        <el-form-item label="名称" prop="name">
          <el-input v-model="temp.name" type="input" placeholder="输入配置名称，作为键值建议英文格式" />
        </el-form-item>
        <el-form-item label="键值" prop="value">
          <el-input v-model="temp.value" :autosize="{ minRows: 10, maxRows: 20}" type="textarea" placeholder="输入配置取值，多个值空格分隔" />
        </el-form-item>
...
<script>
import { fetchConfigList, createConfig, updateConfig } from '@/api/keyword'
