    ...
    >
      ...
      <el-table-column label="任务状态" width="240px">
        <template slot-scope="{row}">
          ...
          <span v-if="row.tid">新帖：<el-link :href="'https://news.discuss.com.hk/viewthread.php?tid=' + row.tid" target="_blank" type="primary">{{ row.tid}}</el-link></span><br/>
...
<script>
import { fetchPostCorpusList, createPostCorpus } from '@/api/discuss'
