...
import { PAGE_SIZE, useTopTokens } from 'graphql/data/TopPool'
...
export default function TokenTable() {
  ...
  //获取数据， tokens, tokenSortRank, loadingTokens, sparklines 就是获取到的数据
  const { tokens, tokenSortRank, loadingTokens, sparklines } = useTopTokens(chainName)
  // 代币列表
  console.log('池子列表上级: ', tokens);
  // 排序数组  address:index
  console.log('tokenSortRank: ', tokenSortRank);
  console.log('loadingTokens: ', loadingTokens);
  console.log('PAGE_SIZE: ', PAGE_SIZE);
  // 曲线（是个二维数组）  address: { 数组}
