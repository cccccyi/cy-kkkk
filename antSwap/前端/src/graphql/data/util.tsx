...
export const CHAIN_ID_TO_BACKEND_NAME: { [key: number]: Chain } = {
  ...
  [SupportedChainId.HASHKEY]: Chain.Hashkey,
}
...
export const CHAIN_NAME_TO_CHAIN_ID: { [key in Chain]: SupportedChainId } = {
  ...
  [Chain.Hashkey]: SupportedChainId.HASHKEY,
}
...
//export const BACKEND_CHAIN_NAMES: Chain[] = [Chain.Ethereum, Chain.Polygon, Chain.Optimism, Chain.Arbitrum, Chain.Celo, Chain.Hashkey]
//代币列表可选中的链
export const BACKEND_CHAIN_NAMES: Chain[] = [Chain.Hashkey]
