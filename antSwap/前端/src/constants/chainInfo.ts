...
import hskTestnetCircleLogoUrl from 'assets/svg/hashkey_circle.svg'
...
import hskTestnetLogo from 'assets/svg/hashkey_circle.svg'
import celoSquareLogoUrl from 'assets/svg/celo_square_logo.svg'
import hskTestnetSquareLogoUrl from 'assets/svg/hashkey_square.svg'
...
import { ARBITRUM_LIST, CELO_LIST, OPTIMISM_LIST, PLASMA_BNB_LIST, HASHKEY_LIST } from './lists'
...
const CHAIN_INFO: ChainInfoMap = {
  ...
  [SupportedChainId.HASHKEY]: {
    ...
    docs: 'https://docs.hsk.xyz/',
    explorer: 'https://docs.hashkeychain.net/',
    infoLink: 'https://docs.hsk.xyz/docs/Build-on-HashKey-Chain/network-info',
    label: 'HashKey',
    logoUrl: hskTestnetLogo,
    circleLogoUrl: hskTestnetCircleLogoUrl,
    squareLogoUrl: hskTestnetSquareLogoUrl,
    nativeCurrency: { name: 'Hashkey Platform Token', symbol: 'HSK', decimals: 18 },
    defaultListUrl: HASHKEY_LIST,
    color: darkTheme.chain_56,
    backgroundColor: darkTheme.chain_56_background,
  },
}
