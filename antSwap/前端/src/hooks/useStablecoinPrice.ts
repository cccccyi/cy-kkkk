...
import { CUSD_CELO, DAI_OPTIMISM, USDC_ARBITRUM, USDC_MAINNET, USDC_POLYGON, USDT_BSC,USDT_HSK } from '../constants/tokens'
...
const STABLECOIN_AMOUNT_OUT: { [chainId: number]: CurrencyAmount<Token> } = {
  ...
  [SupportedChainId.HASHKEY]: CurrencyAmount.fromRawAmount(USDT_HSK, 100e6),
}
