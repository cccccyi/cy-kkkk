      ...
      .then((estimate) => {
        ...
        return provider
          ...
          .then((response: TransactionResponse) => {
            ...
            console.log(TransactionType.REMOVE_LIQUIDITY_V3);
            console.log(currencyId(liquidityValue0.currency));
            console.log(currencyId(liquidityValue1.currency));
            console.log(liquidityValue0.quotient.toString());
            console.log(TransactionType.REMOVE_LIQUIDITY_V3);
            //发送交易
