...
export const FALLBACK_URLS = {
  ...
  [SupportedChainId.HASHKEY]: ['https://mainnet.hsk.xyz'],
}
...
export const RPC_URLS = {
  ...
  [SupportedChainId.GOERLI]: [
    // `https://goerli.infura.io/v3/${INFURA_KEY}`, ...FALLBACK_URLS[SupportedChainId.GOERLI]
  ],
  [SupportedChainId.OPTIMISM]: [
  ...
  [SupportedChainId.CELO_ALFAJORES]: [],
  [SupportedChainId.BNB]: [],
  [SupportedChainId.HASHKEY]: FALLBACK_URLS[SupportedChainId.HASHKEY],
}