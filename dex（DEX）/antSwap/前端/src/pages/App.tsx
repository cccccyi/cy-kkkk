...
import OpenPools from './OpenPools'  
import bgw from 'assets/images/bgwave.webp'
...
const BackgroundIframe = styled.iframe`
  ...
  border: none;
  z-index: 0; /* 在最底层 */
  pointer-events: none; /* 避免挡住前景的点击操作 */
        ...
        >
          ...
          <BodyWrapper>
            {(pathname === '/swap' || pathname === '/') && (
                <BackgroundIframe src="/swapbg/index.html?v=2" />
            )}
            {(pathname === '/tokens/hashkey' || pathname === '/openpools/hashkey' || pathname === '/pools') && (
              <img
                src={bgw}
                alt="Background Wave"
                style={{
            ...
            <Suspense fallback={<Loader />}>
              {isLoaded ? (
                <Routes>
                  ...
                  <Route path="openpools" element={<OpenPools />}>
                    <Route path=":chainName" />
                  </Route>

                  <Route path="openpools/:chainName/:tokenAddress" element={<TokenDetails />} />
