import TokenLogoLookupTable from 'constants/TokenLogoLookupTable'    //获取前端配置的默认list
...
function getInitialUrl(address?: string | null, chainId?: number | null, isNative?: boolean) {
  ...
  //console.log('啊啊啊啊啊'+networkName+checksummedAddress+);
  //获取logo的地方
  if (checksummedAddress) {
    // return `https://raw.githubusercontent.com/Uniswap/assets/master/blockchains/${networkName}/assets/${checksummedAddress}/logo.png`
    console.log('图标地址',checksummedAddress)
    return `https://antswap.org/logo/${checksummedAddress}.webp`
  } else {
    return undefined
  }
}
