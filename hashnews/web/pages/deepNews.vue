      ...
      <div class="mainSection ">
        ...
        <p style="overflow: hidden;" class="inpam">
          ...
          <img src="@/assets/nddark.png" style="width: 128px;display: none;margin-top: 5px;" class="pticon pldark"
            alt="">
          <span class="ndTime">
            <!-- <font-awesome-icon :icon="['far', 'clock']" /> &nbsp;{{formatDate(newsDt.publishTime)}} -->
          </span>
        </p>
        <p class="ndMsg" v-html="processedContent">
        </p>
...
onMounted(() => {
  if (typeof document !== 'undefined') {
    ...
    processedContent.value = processRichText(newsDt.value.content);
  }
});
